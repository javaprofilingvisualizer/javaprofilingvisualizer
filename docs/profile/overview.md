...
**The Sankey shows *flow*.** Samples travel left-to-right along call edges; link width is proportional to sample volume. It answers "through which call paths does the cost arrive?".
